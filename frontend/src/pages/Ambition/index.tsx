      ...
      <div className="relative min-h-[60vh] flex items-center justify-center">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <motion.h1
            ...
            className="text-5xl md:text-7xl font-montserrat font-weight: 600 text-white text-center mb-6 drop-shadow-lg text-bold"
          >
            Our Ambition
          </motion.h1>
          <motion.p
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex flex-col items-center mb-12">
            ...
            <motion.h2
              ...
              transition={{ duration: 0.8 }}
              className="text-5xl font-montserrat font-weight: 600 text-[#0A3622] mb-4 text-center"
            >
              Building a Smarter Future
            </motion.h2>
            <span className="text-green-800 text-2xl text-[#0A3622] font-semibold font-montserrat font-weight: 600 mb-4">"Where innovation meets sustainability"</span>
          </div>
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <p className="text-xl font-montserrat text-[#0A3622] text-left font-weight: 800 text-gray-800 leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-3">
              <LazyImage
                src="\classroom.avif"
                alt="Smart Farming"
                className="rounded-lg shadow-lg w-full h-80 w-full object-cover"
              />
              <LazyImage
                src="\germination.avif"
                alt="Innovation"
                className="rounded-lg shadow-lg w-full h-80 w-full object-cover mt-8"
              />
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-[#e8f5e9]">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex flex-col items-center mb-12">
            ...
            <span className="text-green-800 text-2xl text-[#0A3622] font-semibold font-montserrat font-weight: 600 mb-4">"A world where sustainable agriculture thrives"</span>
          </div>
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="grid grid-cols-2 gap-4">
              ...
              <LazyImage
                src="\hydro4.jpg"
                alt="Future"
                className="rounded-lg shadow-lg w-full h-80 object-cover mt-8"
              />
            </div>
            <div className="space-y-6">
              <p className="text-xl font-montserrat text-[#0A3622] text-left font-weight: 800 text-gray-800 leading-relaxed">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex flex-col items-center mb-12">
            ...
            <span className="text-green-800 text-2xl text-[#0A3622] font-semibold font-montserrat font-weight: 600 mb-4">"Advancing sustainable agriculture through innovation"</span>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-800 font-montserrat text-left font-weight: 800">
      ...
      <section className="py-20 bg-[#e8f5e9]">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex flex-col items-center mb-12">
            ...
            <span className="text-green-800 text-2xl text-[#0A3622] font-semibold font-montserrat font-weight: 600 mb-4">"The future of sustainable farming"</span>
          </div>
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <p className="text-xl font-montserrat text-[#0A3622] text-left font-weight: 800 text-gray-800 leading-relaxed">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex flex-col items-center mb-12">
            ...
            <span className="text-green-800 text-2xl text-[#0A3622] font-semibold font-montserrat font-weight: 600 mb-4">"Feeding the future with roots in water, not in soil"</span> 
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <motion.div
              whileHover={{ scale: 1.05 }}
            ...
            <motion.div
              ...
              className="bg-[#e8f5e9] p-8 rounded-xl shadow-lg text-center"
            >
              <h3 className="text-4xl font-montserrat font-weight: 600 text-[#0A3622] mb-2">70%</h3>
              <p className="text-gray-800 font-montserrat text-[#0A3622] font-weight: 600">Less Land Usage</p>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#e8f5e9]">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex flex-col items-center mb-12">
            ...
            <span className="text-green-800 text-2xl text-[#0A3622] font-semibold font-montserrat font-weight: 600 mb-4">"Join us in cultivating change"</span>
          </div>
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="grid grid-cols-2 gap-4">
              <LazyImage
            ...
            <div className="space-y-6">
              ...
              <p className="text-xl font-montserrat text-[#0A3622] font-weight: 800 text-gray-800 leading-relaxed text-left">
                We're not just cultivating crops — we're cultivating a future, one that places sustainability, innovation, and people at its core. Making change today so we can enjoy a better/sustainable tomorrow.

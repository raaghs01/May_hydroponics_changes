...
export const Contact: FC = () => {
  ...
  useEffect(() => {
    ...
    } else if (regarding === 'volunteer opportunities') {
      if (email && formData.department) {
        allRequiredFieldsFilled = true;
      } else {
        allRequiredFieldsFilled = false;
      }
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Add the regarding field
      formDataToSend.append('regarding', regarding);
              ...
              {regarding === 'volunteer opportunities' && (
                <div>
                  ...
                  <select 
                    ...
                    required
                  >
                    <option value="" className="bg-[#07300f]">Choose a department</option>
                    <option value="technical" className="bg-[#07300f]">Technical</option>
                    <option value="social" className="bg-[#07300f]">Social</option>
                    <option value="general" className="bg-[#07300f]">General</option>
                    <option value="research" className="bg-[#07300f]">Research</option>
                  </select>
                </div>
              )}
              <button 
